      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="mb-6">
              <h3 className="text-2xl font-bold mb-3">ElectroShop</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/shipping" className="text-gray-400 hover:text-white transition duration-300">Shipping Info</a></li>
              <li><a href="/returns" className="text-gray-400 hover:text-white transition duration-300">Returns & Exchanges</a></li>
              <li><a href="/warranty" className="text-gray-400 hover:text-white transition duration-300">Warranty</a></li>
              <li><a href="/track" className="text-gray-400 hover:text-white transition duration-300">Track Your Order</a></li>
